-- =====================================================================
-- Insert 2 sample records into every table of msms_dev
-- Uses existing business_id=4 and branch_id=3 (Main Branch, HQ)
-- Safe to run multiple times is NOT guaranteed (unique codes used are fixed)
-- =====================================================================
...
(3, 'admin_demo1', 'admin_demo1@example.com', 'Demo Admin One', '9000000001',
 '$2b$12$Q7NPAz42gc.ei95bwnZVoOqCqjWdrJD0FlsnZua21T24npYH0gzXi', 'admin', 1, 1,
 'Administrator', 'MCA', 'light', 'en', NOW(), NOW()),
(3, 'pharmacist_demo1', 'pharmacist_demo1@example.com', 'Demo Pharmacist One', '9000000002',
...
(4, 'Demo Category A', NOW()),
(4, 'Demo Category B', NOW());
...
(4, 'SUP-DEMO-01', 'Demo Supplier One', 'Ramesh Kumar', '9111000001', 'supplier1@example.com',
 '27ABCDE1234F1Z5', 'DL-DEMO-001', 'Demo Address 1', 'Mumbai', 'Maharashtra',
 30, 100000.00, 0.00, 5.0, 1, 0, NOW(), NOW()),
(4, 'SUP-DEMO-02', 'Demo Supplier Two', 'Suresh Patel', '9111000002', 'supplier2@example.com',
...
(4, 'PAT-DEMO-01', 'Demo Patient One', '9222000001', 'patient1@example.com', '1990-05-15', 'male',
 'Demo Address 1', 'O+', 0, 0, 'silver', 1, NOW()),
(4, 'PAT-DEMO-02', 'Demo Patient Two', '9222000002', 'patient2@example.com', '1985-08-20', 'female',
...
(4, 'DOC-DEMO-01', 'Dr. Demo One', 'General Physician', 'MBBS',
 'REG-DEMO-001', '9333000001', 'doctor1@example.com', 'Demo Clinic 1', 'Clinic Address 1', 1, NOW()),
(4, 'DOC-DEMO-02', 'Dr. Demo Two', 'Pediatrician', 'MBBS, MD',
 'REG-DEMO-002', '9333000002', 'doctor2@example.com', 'Demo Clinic 2', 'Clinic Address 2', 1, NOW());

-- 6. MEDICINES (2 records) — uses new categories inserted above via subquery
...
(4, 'MED-DEMO-01', 'Demo Paracetamol 500mg', 'Paracetamol', 'Demo Brand P', 'Paracetamol 500mg',
 (SELECT id FROM medicine_categories WHERE name='Demo Category A' LIMIT 1),
 'Demo Pharma Ltd', '30049099', 'OTC', 12.00, 30.00, 15.00, 25.00, 'Strip', 10,
 'DEMOBAR0001', 0, 1, 0, NOW(), NOW()),
(4, 'MED-DEMO-02', 'Demo Amoxicillin 250mg', 'Amoxicillin', 'Demo Brand A', 'Amoxicillin 250mg',
 (SELECT id FROM medicine_categories WHERE name='Demo Category B' LIMIT 1),
...
((SELECT id FROM medicines WHERE medicine_code='MED-DEMO-01' LIMIT 1), 3, 'BATCH-DEMO-01',
 '2026-01-01', '2027-12-31', 100, 0, 15.00, 30.00, 25.00, 'A1', 0, 0, NOW(), NOW()),
((SELECT id FROM medicines WHERE medicine_code='MED-DEMO-02' LIMIT 1), 3, 'BATCH-DEMO-02',
...
(4, 3, 'PO-DEMO-01', (SELECT id FROM suppliers WHERE supplier_code='SUP-DEMO-01' LIMIT 1),
 CURDATE(), CURDATE() + INTERVAL 7 DAY, 'draft', 1500.00, 'Demo PO 1',
 (SELECT id FROM users WHERE username='admin_demo1' LIMIT 1), NOW()),
(4, 3, 'PO-DEMO-02', (SELECT id FROM suppliers WHERE supplier_code='SUP-DEMO-02' LIMIT 1),
...
((SELECT id FROM purchase_orders WHERE po_number='PO-DEMO-01' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-01' LIMIT 1), 100, 15.00),
((SELECT id FROM purchase_orders WHERE po_number='PO-DEMO-02' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-02' LIMIT 1), 50, 45.00);
...
(4, 3, 'PUR-DEMO-01', (SELECT id FROM purchase_orders WHERE po_number='PO-DEMO-01' LIMIT 1),
 (SELECT id FROM suppliers WHERE supplier_code='SUP-DEMO-01' LIMIT 1), CURDATE(),
 'INV-SUP-001', CURDATE(), 1500.00, 0.00, 90.00, 90.00, 0.00, 1680.00, 1680.00, 0.00,
 'bank_transfer', 'paid', 'Demo Purchase 1',
 (SELECT id FROM users WHERE username='admin_demo1' LIMIT 1), NOW()),
(4, 3, 'PUR-DEMO-02', (SELECT id FROM purchase_orders WHERE po_number='PO-DEMO-02' LIMIT 1),
 (SELECT id FROM suppliers WHERE supplier_code='SUP-DEMO-02' LIMIT 1), CURDATE(),
...
((SELECT id FROM purchases WHERE bill_number='PUR-DEMO-01' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-01' LIMIT 1),
 'BATCH-DEMO-01', '2026-01-01', '2027-12-31', 100, 0, 15.00, 30.00, 0.00, 12.00,
 90.00, 90.00, 0.00, 1680.00),
((SELECT id FROM purchases WHERE bill_number='PUR-DEMO-02' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-02' LIMIT 1),
...
(4, 3, 'RX-DEMO-01', (SELECT id FROM patients WHERE patient_code='PAT-DEMO-01' LIMIT 1),
 (SELECT id FROM doctors WHERE doctor_code='DOC-DEMO-01' LIMIT 1), CURDATE(), 1, 30,
 'verified', 'Demo Rx 1', NOW()),
(4, 3, 'RX-DEMO-02', (SELECT id FROM patients WHERE patient_code='PAT-DEMO-02' LIMIT 1),
 (SELECT id FROM doctors WHERE doctor_code='DOC-DEMO-02' LIMIT 1), CURDATE(), 0, 30,
...
((SELECT id FROM prescriptions WHERE prescription_code='RX-DEMO-01' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-01' LIMIT 1),
 'Paracetamol', '1-0-1', '5 days', 'After food', 10, 10),
((SELECT id FROM prescriptions WHERE prescription_code='RX-DEMO-02' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-02' LIMIT 1),
...
(4, 3, 'INV-DEMO-01', (SELECT id FROM patients WHERE patient_code='PAT-DEMO-01' LIMIT 1),
 (SELECT id FROM prescriptions WHERE prescription_code='RX-DEMO-01' LIMIT 1), NOW(),
...
(4, 3, 'INV-DEMO-02', (SELECT id FROM patients WHERE patient_code='PAT-DEMO-02' LIMIT 1),
 NULL, NOW(),
 (SELECT id FROM users WHERE username='pharmacist_demo1' LIMIT 1),
...
((SELECT id FROM sales WHERE invoice_number='INV-DEMO-01' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-01' LIMIT 1),
...
((SELECT id FROM sales WHERE invoice_number='INV-DEMO-02' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-02' LIMIT 1),
...
(4, 3, 'SRET-DEMO-01', (SELECT id FROM sales WHERE invoice_number='INV-DEMO-01' LIMIT 1),
 (SELECT id FROM patients WHERE patient_code='PAT-DEMO-01' LIMIT 1), NOW(),
 'Demo return reason 1', 28.00, 'cash',
 (SELECT id FROM users WHERE username='pharmacist_demo1' LIMIT 1), 'processed'),
(4, 3, 'SRET-DEMO-02', (SELECT id FROM sales WHERE invoice_number='INV-DEMO-02' LIMIT 1),
 (SELECT id FROM patients WHERE patient_code='PAT-DEMO-02' LIMIT 1), NOW(),
...
((SELECT id FROM sales_returns WHERE return_number='SRET-DEMO-01' LIMIT 1),
 (SELECT si.id FROM sale_items si JOIN sales s ON si.sale_id=s.id WHERE s.invoice_number='INV-DEMO-01' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-01' LIMIT 1),
 (SELECT id FROM medicine_batches WHERE batch_number='BATCH-DEMO-01' LIMIT 1), 1, 28.00),
((SELECT id FROM sales_returns WHERE return_number='SRET-DEMO-02' LIMIT 1),
 (SELECT si.id FROM sale_items si JOIN sales s ON si.sale_id=s.id WHERE s.invoice_number='INV-DEMO-02' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-02' LIMIT 1),
...
(4, 3, 'PRET-DEMO-01', (SELECT id FROM purchases WHERE bill_number='PUR-DEMO-01' LIMIT 1),
 (SELECT id FROM suppliers WHERE supplier_code='SUP-DEMO-01' LIMIT 1), CURDATE(),
 'Demo purchase return 1', 150.00, 'pending', NULL, NOW()),
(4, 3, 'PRET-DEMO-02', (SELECT id FROM purchases WHERE bill_number='PUR-DEMO-02' LIMIT 1),
 (SELECT id FROM suppliers WHERE supplier_code='SUP-DEMO-02' LIMIT 1), CURDATE(),
...
((SELECT id FROM purchase_returns WHERE return_number='PRET-DEMO-01' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-01' LIMIT 1),
 (SELECT id FROM medicine_batches WHERE batch_number='BATCH-DEMO-01' LIMIT 1), 10, 15.00, 150.00),
((SELECT id FROM purchase_returns WHERE return_number='PRET-DEMO-02' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-02' LIMIT 1),
...
(4, 3, 'ADJ-DEMO-01', 'damage', 'Demo damage adjustment', 'Damaged in transit',
...
(4, 3, 'ADJ-DEMO-02', 'correction', 'Demo correction adjustment', 'Stock count correction',
...
((SELECT id FROM stock_adjustments WHERE adj_number='ADJ-DEMO-01' LIMIT 1),
 (SELECT id FROM medicine_batches WHERE batch_number='BATCH-DEMO-01' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-01' LIMIT 1), 100, -5, 95, 'Damaged units', NOW()),
((SELECT id FROM stock_adjustments WHERE adj_number='ADJ-DEMO-02' LIMIT 1),
 (SELECT id FROM medicine_batches WHERE batch_number='BATCH-DEMO-02' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-02' LIMIT 1), 50, 2, 52, 'Count correction', NOW());
...
(4, 3, 'schedule_h', (SELECT id FROM sales WHERE invoice_number='INV-DEMO-02' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-02' LIMIT 1),
 (SELECT id FROM patients WHERE patient_code='PAT-DEMO-02' LIMIT 1),
 (SELECT id FROM doctors WHERE doctor_code='DOC-DEMO-02' LIMIT 1),
 (SELECT id FROM prescriptions WHERE prescription_code='RX-DEMO-02' LIMIT 1),
 1, NOW(), (SELECT id FROM users WHERE username='pharmacist_demo1' LIMIT 1), 'BATCH-DEMO-02', 'Demo compliance 1'),
(4, 3, 'rx_log', (SELECT id FROM sales WHERE invoice_number='INV-DEMO-01' LIMIT 1),
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-01' LIMIT 1),
 (SELECT id FROM patients WHERE patient_code='PAT-DEMO-01' LIMIT 1),
 (SELECT id FROM doctors WHERE doctor_code='DOC-DEMO-01' LIMIT 1),
 (SELECT id FROM prescriptions WHERE prescription_code='RX-DEMO-01' LIMIT 1),
 10, NOW(), (SELECT id FROM users WHERE username='pharmacist_demo1' LIMIT 1), 'BATCH-DEMO-01', 'Demo compliance 2');

-- 23. DRUG INTERACTIONS (2 records)
...
(4, 3, 'sale', (SELECT id FROM sales WHERE invoice_number='INV-DEMO-01' LIMIT 1), 'sale', NULL,
 CURDATE(), 250.00, 6.00, 15.00, 6.00, 15.00, 0.00, 0.00, '30049099', '2026-2027', '2026-07', 0, NOW()),
(4, 3, 'purchase', (SELECT id FROM purchases WHERE bill_number='PUR-DEMO-01' LIMIT 1), 'purchase', NULL,
...
(4, 'DEMO-A1', 'Demo Cash Account', 'asset', NULL, 0, NOW()),
(4, 'DEMO-R1', 'Demo Sales Revenue', 'revenue', NULL, 0, NOW());
...
(4, 3, 'JE-DEMO-01', CURDATE(), 'sale', (SELECT id FROM sales WHERE invoice_number='INV-DEMO-01' LIMIT 1),
 'Demo journal entry 1', 280.00, 280.00, (SELECT id FROM users WHERE username='admin_demo1' LIMIT 1), NOW()),
(4, 3, 'JE-DEMO-02', CURDATE(), 'purchase', (SELECT id FROM purchases WHERE bill_number='PUR-DEMO-01' LIMIT 1),
...
((SELECT id FROM journal_entries WHERE entry_number='JE-DEMO-01' LIMIT 1),
 (SELECT id FROM chart_of_accounts WHERE code='DEMO-A1' LIMIT 1), 280.00, 0.00),
((SELECT id FROM journal_entries WHERE entry_number='JE-DEMO-02' LIMIT 1),
 (SELECT id FROM chart_of_accounts WHERE code='DEMO-R1' LIMIT 1), 0.00, 1680.00);

-- 28. LOYALTY PROGRAMS (only 1 per business allowed due to unique business_id — inserting 1 for business 4 if missing, skip 2nd)
...
SELECT 4, 'Demo Loyalty Program', 1, 0.25, 100, 365, 0, 10000, 50000, 0, 2, 5, 50, 1
WHERE NOT EXISTS (SELECT 1 FROM loyalty_programs WHERE business_id = 4);
...
((SELECT id FROM patients WHERE patient_code='PAT-DEMO-01' LIMIT 1),
 (SELECT id FROM sales WHERE invoice_number='INV-DEMO-01' LIMIT 1), 'earn', 2, 2, 'Demo loyalty earn', NOW()),
((SELECT id FROM patients WHERE patient_code='PAT-DEMO-02' LIMIT 1),
 (SELECT id FROM sales WHERE invoice_number='INV-DEMO-02' LIMIT 1), 'earn', 1, 1, 'Demo loyalty earn 2', NOW());
...
(4, 3, (SELECT id FROM users WHERE username='admin_demo1' LIMIT 1), 'low_stock',
 'Demo Low Stock Alert', 'Demo medicine running low', 'medicine',
 (SELECT id FROM medicines WHERE medicine_code='MED-DEMO-01' LIMIT 1), 0, 'high', NULL, NOW()),
(4, 3, (SELECT id FROM users WHERE username='pharmacist_demo1' LIMIT 1), 'expiry',
...
(4, (SELECT id FROM patients WHERE patient_code='PAT-DEMO-01' LIMIT 1), '9222000001', 'invoice',
 'sale', (SELECT id FROM sales WHERE invoice_number='INV-DEMO-01' LIMIT 1),
 'Demo invoice message', 'sent', NULL, (SELECT id FROM users WHERE username='admin_demo1' LIMIT 1), NOW()),
(4, (SELECT id FROM patients WHERE patient_code='PAT-DEMO-02' LIMIT 1), '9222000002', 'payment_reminder',
 'sale', (SELECT id FROM sales WHERE invoice_number='INV-DEMO-02' LIMIT 1),
...
(4, (SELECT id FROM users WHERE username='admin_demo1' LIMIT 1), 'Demo question 1', 'Demo answer 1', 'stock_query', NOW()),
(4, (SELECT id FROM users WHERE username='pharmacist_demo1' LIMIT 1), 'Demo question 2', 'Demo answer 2', 'sales_query', NOW());
...
((SELECT id FROM users WHERE username='pharmacist_demo1' LIMIT 1), 'create', 'sales', 'Demo audit log 2',
 'Sale', (SELECT id FROM sales WHERE invoice_number='INV-DEMO-01' LIMIT 1), 'info', NOW());

-- 34. SEQUENCES (2 records)
INSERT INTO sequences (`key`, current_value, prefix, pad_length, reset_yearly, last_reset_year, created_at, updated_at)
SELECT 'demo_seq_1', 1, 'DS1', 6, 0, YEAR(CURDATE()), NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM sequences WHERE `key` = 'demo_seq_1');

INSERT INTO sequences (`key`, current_value, prefix, pad_length, reset_yearly, last_reset_year, created_at, updated_at)
SELECT 'demo_seq_2', 1, 'DS2', 6, 0, YEAR(CURDATE()), NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM sequences WHERE `key` = 'demo_seq_2');
